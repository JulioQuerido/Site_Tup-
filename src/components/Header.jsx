...
export default function Header({ activeSection, scrollToSection, currentRoute, session }) {
  ...
  // Removing dropdown hook

  const isLandingRoute = !currentRoute || currentRoute === '#/';
  // Admin route check removed from UI to hide it
        ...
        <div className="md:hidden bg-[#131313] border-t border-white/10 px-container-margin py-4 space-y-3 animate-fadeIn">
          ...
          <div className="border-t border-white/5 pt-3 mt-3">
            <a 
              ...
              className="flex items-center gap-2 text-left py-2.5 px-3 rounded text-sm text-on-surface-variant hover:bg-surface-container hover:text-primary transition-all uppercase tracking-wider font-bold"
            >
